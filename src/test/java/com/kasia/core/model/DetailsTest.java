...
public class DetailsTest {
    ...
    /**
     ...
     @Test public void setNameWithUpperCase() {
     details.setName("NAME");
     assertThat(details.getName()).isEqualTo("NAME");
     }

     @Test public void setNameWithLowerCase() {
     details.setName("name");
     assertThat(details.getName()).isEqualTo("NAME");
     }

     @Test public void setNameIgnoreExtraWhiteSymbols() {
     details.setName("   Name    ");
     assertThat(details.getName()).isEqualTo("NAME");
     }

     @Test public void setNameWithWhiteSymbols() {
     details.setName("    ");
     assertThat(details.getName()).isEqualTo("");
     }

     @Test public void setNameWithEmptyString() {
     details.setName("");
     assertThat(details.getName()).isEqualTo("");
     }
     ...
     @Test public void whenNameNullGetterReturnEmptySttring() {
     assertThat(details.getName()).isEqualTo("");
     }
     ...
     @Test public void setSurnameWithUpperCase() {
     details.setSurname("SURNAME");
     assertThat(details.getSurname()).isEqualTo("SURNAME");
     }

     @Test public void setSurnameWithLowerCase() {
     details.setSurname("surname");
     assertThat(details.getSurname()).isEqualTo("SURNAME");
     }

     @Test public void setSurnameIgnoreExtraWhiteSymbols() {
     details.setSurname("   Surname    ");
     assertThat(details.getSurname()).isEqualTo("SURNAME");
     }

     @Test public void setCompositeSurname() {
     details.setSurname("Surname-Surname");
     assertThat(details.getSurname()).isEqualTo("SURNAME-SURNAME");
     }

     @Test public void setSurnameWithWhiteSymbols() {
     details.setSurname("    ");
     assertThat(details.getSurname()).isEqualTo("");
     }

     @Test public void setSurnameWithEmptyString() {
     details.setSurname("");
     assertThat(details.getSurname()).isEqualTo("");
     }
     ...
     @Test public void whenSurnameNullGetterReturnEmptySttring() {
     assertThat(details.getSurname()).isEqualTo("");
     }

     @Test public void setFirm() {
     details.setFirm("Firm");
     assertThat(details.getFirm()).isEqualTo("FIRM");
     }

     @Test public void setFirmNameWithUpperCase() {
     details.setFirm("FIRM");
     assertThat(details.getFirm()).isEqualTo("FIRM");
     }

     @Test public void setFirmNameWithLowerCase() {
     details.setFirm("firm32");
     assertThat(details.getFirm()).isEqualTo("FIRM32");
     }

     @Test public void setFirmNameIgnoreExtraWhiteSymbols() {
     details.setFirm("   Firm    firm   ");
     assertThat(details.getFirm()).isEqualTo("FIRM FIRM");
     }

     @Test public void setCompositeFirmName() {
     details.setFirm("Firm-firm");
     assertThat(details.getFirm()).isEqualTo("FIRM-FIRM");
     }

     @Test public void setFirmNameWithWhiteSymbols() {
     details.setFirm("    ");
     assertThat(details.getFirm()).isEqualTo("");
     }

     @Test public void setFirmNameWithEmptyString() {
     details.setFirm("");
     assertThat(details.getFirm()).isEqualTo("");
     }

     @Test public void setFirmNameWithPlus() {
     details.setFirm(" A+B Firm");
     assertThat(details.getFirm()).isEqualTo("A+B FIRM");
     }

     @Test public void setFirmNameWithAmpersant() {
     details.setFirm(" A&B Firm");
     assertThat(details.getFirm()).isEqualTo("A&B FIRM");
     }

     @Test public void setFirmNameWithAtSign() {
     details.setFirm(" A@B Firm");
     assertThat(details.getFirm()).isEqualTo("A@B FIRM");
     }

     @Test public void setFirmNameWithPoint() {
     details.setFirm(" A.B Firm");
     assertThat(details.getFirm()).isEqualTo("A.B FIRM");
     }
     ...
     @Test public void whenFirmNullGetterReturnEmptyString() {
     assertThat(details.getFirm()).isEqualTo("");
     }

     @Test public void setPosition() {
     details.setPosition("Position");
     assertThat(details.getPosition()).isEqualTo("POSITION");
     }

     @Test public void setPositionWithUpperCase() {
     details.setPosition("POSITION");
     assertThat(details.getPosition()).isEqualTo("POSITION");
     }

     @Test public void setPositionWithLowerCase() {
     details.setPosition("position32");
     assertThat(details.getPosition()).isEqualTo("POSITION32");
     }

     @Test public void setPositionIgnoreExtraWhiteSymbols() {
     details.setPosition("   Position&    ");
     assertThat(details.getPosition()).isEqualTo("POSITION&");
     }

     @Test public void setCompositePositionWithDesh() {
     details.setPosition("Position-position");
     assertThat(details.getPosition()).isEqualTo("POSITION-POSITION");
     }

     @Test public void setCompositePositionWithWhiteSymbol() {
     details.setPosition("Position position");
     assertThat(details.getPosition()).isEqualTo("POSITION POSITION");
     }

     @Test public void setPositionWithWhiteSymbols() {
     details.setPosition("    ");
     assertThat(details.getPosition()).isEqualTo("");
     }

     @Test public void setPositionWithEmptyString() {
     details.setPosition("");
     assertThat(details.getPosition()).isEqualTo("");
     }
     ...
     @Test public void whenPositionNullGetterReturnEmptyString() {
     assertThat(details.getPosition()).isEqualTo("");
     }
     ...
     @Test public void getDetailsOfNameSurnameFirmPosition() {
     ...
     @Test public void checkEqualsAndHashCode() {
     EqualsVerifier.forClass(Details.class)
     ...
     @Test public void checkToStringWithEmptyString() {
     Details details = new Details();
     assertThat(details.toString()).isEqualTo("0::::");
     }

     @Test public void checkValueOf() {
     ...
     @Test public void getDetailsFromAnotherDetails() {
     details = new Details("NAME", "SURNAME", "FIRM NAME", "POSITION");
